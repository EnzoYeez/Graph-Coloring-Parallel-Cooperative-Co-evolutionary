...
def run_de_global(logger: Optional[RunLogger], seed: int, run_id: int = 1):
    ...
    best_obj, best_cost, best_viol = best_fit, best_cost, best_viol
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run DE baseline in single-run mode (external scheduler friendly).")
